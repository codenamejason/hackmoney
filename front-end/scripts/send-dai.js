...
const DAI_ADDRESS = '0xf80A32A835F79D7787E8a8ee5721D0fEaFd78108'; // ropsten
...
const daiHolder = 'outside bridge shrimp above piece myth acquire doll void filter fit reject';


module.exports = async (callback) => {
    try {
        // run your script here
        // get the balance of daiHolder
        ...
        await daiContract.methods.transfer(
            recipient, web3.utils.toWei('100', 'Ether')
        ).send({ from: daiHolder }); // specify who is signing...        

        // get the recipient balance
        const recipientBalance = await daiContract.methods.balanceOf(recipient).call();
        console.log('Balance of Recipient after tx: ', recipientBalance);
